...
//       axios
//         .get(
//           `https://api.currencyapi.com/v3/latest?apikey=cur_live_s3HPUzSUq9TAbPcMUyaTV5TYjjvBelJj5QiJKEgw&currencies=EUR%2CUSD%2CGBP%2CCHF&base_currency=PLN`
//         )
//         .then((currenciesApi) => {
//           const currencies = Object.keys(currenciesApi.data.rates).map(
//             (key) => {
//               return {
//                 short: key,
